...
<head>
    ...
    <script src="https://kit.fontawesome.com/17361583c9.js" crossorigin="anonymous"></script> <!--Font Awesome Free -->
...
<body>
    ...
    <!-- Main tab -->
    <section id="main_cont" class="cont selected">
        <?php require '../back/php.php'; ?>
    ...
    <!-- Add spent tab -->
    <section id="add_cont" class="cont">
        <h1>Añadir Gasto</h1>
        <div id="divForm">
    ...
    <!-- Category tab -->
    <section id="cat_cont" class="cont">
        <div id="selectorCat">
    ...
    <!-- Report tab -->
    <section id="inf_cont" class="cont">
        <div id="form_informe">
            <h1>Informe pdf</h1>
