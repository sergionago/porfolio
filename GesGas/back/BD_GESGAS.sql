...
insert into user_info values (1, "user", "user","user@gmail.com");
...
update user_info set telefono=675234897, direccion="C\ Alcalde Joaquin, Nº35" where id_user=1
delete from user_info where id=1
alter table user_info add column primer_apellido varchar(20);
insert into user_info values (1, "Sergio.", aes_encrypt("usuario", "666"), "serfer65@gmail.com", 675234897, "C\ Alcalde Joaquin, Nº35"); 
alter table user_info add column telefono dec(9,0);
alter table user_info add column direccion varchar(60);
alter table user_info change username Nombre VARCHAR(100);
