...
//CONEXIÓN
$mysqli_conn = new mysqli('localhost', 'root', '', 'gesgas');
    ...
    if ($resultado_mensual) {
        ...
        foreach ($resultado_mensual as $i => $valor) {
            ...
            switch ($datos_mensual[$i]['MES']) {
                case 1:
                    $datos_mensual[$i]['MES'] = "Enero";
                    break;
                case 2:
                    $datos_mensual[$i]['MES'] = "Febrero";
                    break;
                case 3:
                    $datos_mensual[$i]['MES'] = "Marzo";
                    break;
                case 4:
                    $datos_mensual[$i]['MES'] = "Abril";
                    break;
                case 5:
                    $datos_mensual[$i]['MES'] = "Mayo";
                    break;
                case 6:
                    $datos_mensual[$i]['MES'] = "Junio";
                    break;
                case 7:
                    $datos_mensual[$i]['MES'] = "Julio";
                    break;
                case 8:
                    $datos_mensual[$i]['MES'] = "Agosto";
                    break;
                case 9:
                    $datos_mensual[$i]['MES'] = "Septiembre";
                    break;
                case 10:
                    $datos_mensual[$i]['MES'] = "Octubre";
                    break;
                case 11:
                    $datos_mensual[$i]['MES'] = "Noviembre";
                    break;
                case 12:
                    $datos_mensual[$i]['MES'] = "Diciembre";
                    break;
            }
        }
    ...
    if ($accion === "datos_tabla") {
        ...
        foreach ($resultado_tabla as $i => $rt) {
            ...
            switch ($datos_tabla[$i]["Categoria"]) {
                case 1:
                    $datos_tabla[$i]["Categoria"] = "Transporte";
                    break;
                case 2:
                    $datos_tabla[$i]["Categoria"] = "Ocio";
                    break;
                case 3:
                    $datos_tabla[$i]["Categoria"] = "Alimentación";
                    break;
                case 4:
                    $datos_tabla[$i]["Categoria"] = "Trabajo";
                    break;
                case 5:
                    $datos_tabla[$i]["Categoria"] = "Hogar";
                    break;
                case 6:
                    $datos_tabla[$i]["Categoria"] = "Ropa";
                    break;
                case 7:
                    $datos_tabla[$i]["Categoria"] = "Otras compras";
                    break;
                case 8:
                    $datos_tabla[$i]["Categoria"] = "Salud";
                    break;
            }
        }
